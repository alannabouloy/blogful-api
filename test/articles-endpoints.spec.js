...
describe('Article Endpoints', function() {
    ...
    describe(`GET /api/articles`, () => {
        context('Given there are articles in the database', () => {
            ...
            it('GET /api/articles should respond with all articles in blogful_articles', () => {
    ...
    describe(`POST /api/articles`, () => {
        it('creates an article, responding with 201 and the new article created', function() {
            this.retries(3)
            const newArticle = {
        ...
        context(`Given there are articles in the database`, () => {
            ...
            it(`responds with 204 when updating only a subset of fields`, () => {
                ...
                return supertest(app)
                    ...
                    .send({
                        ...updateArticle,
                        feildToIgnore: 'should not be in GET response'
                    })
                    .expect(204)
                    .then(res =>
                        supertest(app)
